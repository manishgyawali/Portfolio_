...
const Profile = () => {
  return (
    <div className=" md:flex lg:fixed top-[54%] left-12 transform -translate-y-1/2 z-50">
      <div className="bg-[#1c1c1e] w-[280px] lg:w-[450px]  py-6 flex flex-col gap-6 items-center rounded-3xl shadow-lg">
        ...
        <div className="text-center w-7/12 ">
          <button className="w-full cursor-pointer px-2 py-2 bg-purple-700 text-lg rounded-xl text-white">
            Let's Talk
          </button>
        </div>
      </div>
