...
export const Timeline = ({
  ...
  <p className="text-sm md:text-base text-neutral-700 dark:text-neutral-300">
    For the past 2 years, I've been crafting and launching projects, learning deeply about frontend development, and building Aceternity from scratch. Here's a visual timeline of my journey!
  </p>
</div>
