...
export function Features({ featureData, heading, subtext }) {
  return (
    <div className="relative z-20  w-10/12 mx-auto">
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl text-center font-medium text-black dark:text-white">
          {heading}
        </h4>
        <p className="text-sm lg:text-base text-neutral-500 dark:text-neutral-300 text-center my-4">
          {subtext}
        </p>
      </div>
